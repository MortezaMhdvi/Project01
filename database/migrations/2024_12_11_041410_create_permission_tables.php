...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        if ($teams && empty($columnNames['team_foreign_key'] ?? null)) {
            throw new \Exception('Error: team_foreign_key on config/roles.php not loaded. Run [php artisan config:clear] and try again.');
        }
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
            ...
            if ($teams || config('roles.testing')) { // roles.testing is a fix for sqlite testing
        ...
        app('cache')
            ->store(config('roles.cache.store') != 'default' ? config('roles.cache.store') : null)
            ->forget(config('roles.cache.key'));
    }
